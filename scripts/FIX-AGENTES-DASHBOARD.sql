-- Ejecutar en Supabase SQL Editor si no corre migración automática
-- (mismo contenido que supabase/migrations/103_agentes_dashboard.sql)
...
DROP POLICY IF EXISTS agente_conv_select_panel ON agente_conversaciones;
