...
export default function AgentesPruebaClient() {
  ...
  return (
    <main style={{ maxWidth: 640, margin: '2rem auto', padding: '0 1rem', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>Prueba — Agentes IA</h1>
      <p style={{ color: '#555', marginBottom: '1rem' }}>
        Solo personal autorizado. Marque &quot;Enviar WhatsApp real&quot; para probar envío al teléfono.
      </p>
